...
public:
  ...
  enum {
    ...
    RuleVariable_decl = 4, RuleArray_decl = 5, RuleTuple_decl = 6, RuleType = 7, 
    RuleBasic_type = 8, RuleStatements = 9, RuleStatement = 10, RuleLeft_expr = 11, 
  ...
  class  Tuple_declContext : public antlr4::ParserRuleContext {
  public:
    Tuple_declContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  UnpackContext : public StatementContext {
  public:
    UnpackContext(StatementContext *ctx);

    antlr4::tree::TerminalNode *UNPACK();
    IdentContext *ident();
    std::vector<Left_exprContext *> left_expr();
    Left_exprContext* left_expr(size_t i);
    virtual antlrcpp::Any accept(antlr4::tree::ParseTreeVisitor *visitor) override;
  };
  ...
  class  PackContext : public StatementContext {
  public:
    PackContext(StatementContext *ctx);
  ...
  class  LeftTupleContext : public Left_exprContext {
  public:
    LeftTupleContext(Left_exprContext *ctx);
