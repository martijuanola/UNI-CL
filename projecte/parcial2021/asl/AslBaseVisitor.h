...
public:
  ...
  virtual antlrcpp::Any visitTuple_decl(AslParser::Tuple_declContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitPack(AslParser::PackContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitUnpack(AslParser::UnpackContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitLeftExprIdent(AslParser::LeftExprIdentContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitLeftTuple(AslParser::LeftTupleContext *ctx) override {
    return visitChildren(ctx);
  }
