...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitTuple_decl(AslParser::Tuple_declContext *context) = 0;
    ...
    virtual antlrcpp::Any visitPack(AslParser::PackContext *context) = 0;

    virtual antlrcpp::Any visitUnpack(AslParser::UnpackContext *context) = 0;

    virtual antlrcpp::Any visitLeftExprIdent(AslParser::LeftExprIdentContext *context) = 0;

    virtual antlrcpp::Any visitLeftTuple(AslParser::LeftTupleContext *context) = 0;
