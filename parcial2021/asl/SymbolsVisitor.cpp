...
antlrcpp::Any SymbolsVisitor::visitTuple_decl(AslParser::Tuple_declContext *ctx) {
  DEBUG_ENTER();
	std::vector<TypesMgr::TypeId> ts;
	for(auto param : ctx->basic_type()) {
		visit(param);
		TypesMgr::TypeId paramType = getTypeDecor(param);
		ts.push_back(paramType);
	}
  TypesMgr::TypeId t = Types.createTupleTy(ts);
  putTypeDecor(ctx, t);
  DEBUG_EXIT();
  return 0;
}
...
antlrcpp::Any SymbolsVisitor::visitType(AslParser::TypeContext *ctx) {
  ...
  else if(ctx->tuple_decl()) {
	  visit(ctx->tuple_decl());
	  putTypeDecor(ctx, getTypeDecor(ctx->tuple_decl()));
  }
  DEBUG_EXIT();
  return 0;
}
...
//NEW!
antlrcpp::Any SymbolsVisitor::visitPack(AslParser::PackContext *ctx) {
	DEBUG_ENTER();
	antlrcpp::Any r = visitChildren(ctx);
	DEBUG_EXIT();
	return r;
...
antlrcpp::Any SymbolsVisitor::visitUnpack(AslParser::UnpackContext *ctx) {
	DEBUG_ENTER();
	antlrcpp::Any r = visitChildren(ctx);
	DEBUG_EXIT();
	return r;
...
antlrcpp::Any SymbolsVisitor::visitLeftExprIdent(AslParser::LeftExprIdentContext *ctx) {
  DEBUG_ENTER();
  antlrcpp::Any r = visitChildren(ctx);
  DEBUG_EXIT();
  return r;
...
antlrcpp::Any SymbolsVisitor::visitLeftTuple(AslParser::LeftTupleContext *ctx) {
  DEBUG_ENTER();
  antlrcpp::Any r = visitChildren(ctx);
  DEBUG_EXIT();
  return r;
...
antlrcpp::Any SymbolsVisitor::visitTuple(AslParser::TupleContext *ctx) {
  DEBUG_ENTER();
  antlrcpp::Any r = visitChildren(ctx);
  DEBUG_EXIT();
  return r;
